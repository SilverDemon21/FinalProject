...
public class WifiReceiver extends BroadcastReceiver {
    ...
    public WifiReceiver(TextView textView){
    ...
    private void updateTextView(Context context) {
        ...
        if (!isConnected && !hasWiFi) {
            ...
            statusTextView.setBackgroundResource(R.drawable.background_person_disconnected);;
        } else {
            statusTextView.setText("Connected");
            statusTextView.setBackgroundResource(R.drawable.background_person_connected);
        }
    }
}